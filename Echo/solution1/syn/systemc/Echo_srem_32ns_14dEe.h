...
#ifndef __Echo_srem_32ns_14dEe__HH__
#define __Echo_srem_32ns_14dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Echo_srem_32ns_14dEe) {
    ...
    SC_CTOR(Echo_srem_32ns_14dEe):  ACMP_srem_seq_U ("ACMP_srem_seq_U") {

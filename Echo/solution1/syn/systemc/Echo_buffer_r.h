...
#ifndef __Echo_buffer_r_H__
#define __Echo_buffer_r_H__
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(Echo_buffer_r_ram) {
        for (unsigned i = 0; i < 48000; i = i + 1) {
            ram[i] = 0;
        }
...
Echo_buffer_r_ram* meminst;


SC_CTOR(Echo_buffer_r) {
meminst = new Echo_buffer_r_ram("Echo_buffer_r_ram");

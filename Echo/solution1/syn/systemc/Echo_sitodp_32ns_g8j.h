...
#ifndef __Echo_sitodp_32ns_g8j__HH__
#define __Echo_sitodp_32ns_g8j__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Echo_sitodp_32ns_g8j) {
    ...
    SC_CTOR(Echo_sitodp_32ns_g8j):  ACMP_sitodp_U ("ACMP_sitodp_U") {

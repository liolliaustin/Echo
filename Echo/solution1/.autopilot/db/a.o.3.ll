; ModuleID = '/home/hildeb47/proj/ECE1373_GhostSynth/modules/Echo/Echo/solution1/.autopilot/db/a.o.3.bc'
...
define void @Echo(float* %value_in_V, float* %value_out_V, i32 %delay, float %scale) {
  ...
  %delay_read = call i32 @_ssdm_op_Read.s_axilite.i32(i32 %delay) ; [#uses=3 type=i32]
  ...
  %delaycheck_load = load i32* @delaycheck, align 4, !dbg !124 ; [#uses=1 type=i32] [debug line = 38:2]
  %tmp_1 = icmp eq i32 %delaycheck_load, %delay_read, !dbg !124 ; [#uses=1 type=i1] [debug line = 38:2]
  %readBuffer_load = load i32* @readBuffer, align 4, !dbg !125 ; [#uses=4 type=i32] [debug line = 39:3]
  %writeBuffer_load = load i32* @writeBuffer, align 4, !dbg !127 ; [#uses=1 type=i32] [debug line = 49:2]
  br i1 %tmp_1, label %._crit_edge, label %1, !dbg !124 ; [debug line = 38:2]

; <label>:1                                       ; preds = %0
  %tmp1 = add i32 %delay_read, 4800, !dbg !125    ; [#uses=1 type=i32] [debug line = 39:3]
  %tmp_3 = add i32 %tmp1, %readBuffer_load, !dbg !125 ; [#uses=1 type=i32] [debug line = 39:3]
  %tmp_4 = srem i32 %tmp_3, 4800, !dbg !125       ; [#uses=1 type=i32] [debug line = 39:3]
  store i32 %delay_read, i32* @delaycheck, align 4, !dbg !128 ; [debug line = 40:3]
  br label %._crit_edge, !dbg !129                ; [debug line = 41:2]

._crit_edge:                                      ; preds = %1, %0
  %writeBuffer_loc = phi i32 [ %writeBuffer_load, %0 ], [ %tmp_4, %1 ] ; [#uses=3 type=i32]
  call void @llvm.dbg.value(metadata !{float* %value_in_V}, i64 0, metadata !130), !dbg !135 ; [debug line = 101:48@45:2] [debug variable = stream<float>.V]
  call void @llvm.dbg.value(metadata !{float* %value_in_V}, i64 0, metadata !137), !dbg !140 ; [debug line = 123:48@102:9@45:2] [debug variable = stream<float>.V]
  %tmp_10 = call float @_ssdm_op_Read.axis.volatile.floatP(float* %value_in_V), !dbg !143 ; [#uses=1 type=float] [debug line = 125:9@102:9@45:2]
  call void @llvm.dbg.value(metadata !{float %tmp_10}, i64 0, metadata !145), !dbg !143 ; [debug line = 125:9@102:9@45:2] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{float %tmp_10}, i64 0, metadata !146), !dbg !147 ; [debug line = 126:9@102:9@45:2] [debug variable = current_value]
  %tmp_6 = sext i32 %readBuffer_load to i64, !dbg !148 ; [#uses=1 type=i64] [debug line = 47:2]
  %buffer_addr = getelementptr inbounds [4800 x float]* @buffer, i64 0, i64 %tmp_6, !dbg !148 ; [#uses=1 type=float*] [debug line = 47:2]
  %buffer_load = load float* %buffer_addr, align 4, !dbg !148 ; [#uses=1 type=float] [debug line = 47:2]
  %tmp_7 = fmul float %buffer_load, %scale_read, !dbg !148 ; [#uses=1 type=float] [debug line = 47:2]
  %current_value = fadd float %tmp_10, %tmp_7, !dbg !148 ; [#uses=2 type=float] [debug line = 47:2]
  call void @llvm.dbg.value(metadata !{float %current_value}, i64 0, metadata !146), !dbg !148 ; [debug line = 47:2] [debug variable = current_value]
  %tmp_8 = sext i32 %writeBuffer_loc to i64, !dbg !127 ; [#uses=1 type=i64] [debug line = 49:2]
  %buffer_addr_1 = getelementptr inbounds [4800 x float]* @buffer, i64 0, i64 %tmp_8, !dbg !127 ; [#uses=1 type=float*] [debug line = 49:2]
  store float %current_value, float* %buffer_addr_1, align 4, !dbg !127 ; [debug line = 49:2]
  call void @llvm.dbg.value(metadata !{float* %value_out_V}, i64 0, metadata !149), !dbg !152 ; [debug line = 105:48@51:2] [debug variable = stream<float>.V]
  call void @llvm.dbg.value(metadata !{float* %value_out_V}, i64 0, metadata !154), !dbg !157 ; [debug line = 144:48@106:9@51:2] [debug variable = stream<float>.V]
  call void @llvm.dbg.value(metadata !{float %current_value}, i64 0, metadata !160), !dbg !162 ; [debug line = 145:31@106:9@51:2] [debug variable = tmp]
  call void @_ssdm_op_Write.axis.volatile.floatP(float* %value_out_V, float %current_value), !dbg !163 ; [debug line = 146:9@106:9@51:2]
  %tmp_s = icmp slt i32 %readBuffer_load, 4799, !dbg !164 ; [#uses=1 type=i1] [debug line = 53:2]
  %tmp_9 = add nsw i32 %readBuffer_load, 1, !dbg !165 ; [#uses=1 type=i32] [debug line = 54:3]
  %storemerge = select i1 %tmp_s, i32 %tmp_9, i32 0, !dbg !164 ; [#uses=1 type=i32] [debug line = 53:2]
  store i32 %storemerge, i32* @readBuffer, align 4, !dbg !165 ; [debug line = 54:3]
  %tmp_2 = icmp slt i32 %writeBuffer_loc, 4799, !dbg !166 ; [#uses=1 type=i1] [debug line = 58:2]
  %tmp_5 = add nsw i32 %writeBuffer_loc, 1, !dbg !167 ; [#uses=1 type=i32] [debug line = 59:3]
  %storemerge5 = select i1 %tmp_2, i32 %tmp_5, i32 0, !dbg !166 ; [#uses=1 type=i32] [debug line = 58:2]
  store i32 %storemerge5, i32* @writeBuffer, align 4, !dbg !125 ; [debug line = 39:3]
  ret void, !dbg !168                             ; [debug line = 64:1]
}
...
!42 = metadata !{i32 786473, metadata !"src/Echo.cpp", metadata !"/home/hildeb47/proj/ECE1373_GhostSynth/modules/Echo", null} ; [ DW_TAG_file_type ]
...
!48 = metadata !{i32 786473, metadata !"/opt/Xilinx_2017_2/Vivado_HLS/2017.2/common/technology/autopilot/hls_stream.h", metadata !"/home/hildeb47/proj/ECE1373_GhostSynth/modules/Echo", null} ; [ DW_TAG_file_type ]
...
!124 = metadata !{i32 38, i32 2, metadata !118, null}
!125 = metadata !{i32 39, i32 3, metadata !126, null}
!126 = metadata !{i32 786443, metadata !118, i32 38, i32 25, metadata !42, i32 1} ; [ DW_TAG_lexical_block ]
!127 = metadata !{i32 49, i32 2, metadata !118, null}
!128 = metadata !{i32 40, i32 3, metadata !126, null}
!129 = metadata !{i32 41, i32 2, metadata !126, null}
!130 = metadata !{i32 790531, metadata !131, metadata !"stream<float>.V", null, i32 101, metadata !134, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!131 = metadata !{i32 786689, metadata !132, metadata !"this", metadata !48, i32 16777317, metadata !133, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!132 = metadata !{i32 786478, i32 0, metadata !47, metadata !"operator>>", metadata !"operator>>", metadata !"_ZN3hls6streamIfErsERf", metadata !48, i32 101, metadata !73, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !72, metadata !56, i32 101} ; [ DW_TAG_subprogram ]
!133 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !46} ; [ DW_TAG_pointer_type ]
!134 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !111} ; [ DW_TAG_pointer_type ]
!135 = metadata !{i32 101, i32 48, metadata !132, metadata !136}
!136 = metadata !{i32 45, i32 2, metadata !118, null}
!137 = metadata !{i32 790531, metadata !138, metadata !"stream<float>.V", null, i32 123, metadata !134, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!138 = metadata !{i32 786689, metadata !139, metadata !"this", metadata !48, i32 16777339, metadata !133, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!139 = metadata !{i32 786478, i32 0, metadata !47, metadata !"read", metadata !"read", metadata !"_ZN3hls6streamIfE4readERf", metadata !48, i32 123, metadata !73, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !87, metadata !56, i32 123} ; [ DW_TAG_subprogram ]
!140 = metadata !{i32 123, i32 48, metadata !139, metadata !141}
!141 = metadata !{i32 102, i32 9, metadata !142, metadata !136}
!142 = metadata !{i32 786443, metadata !132, i32 101, i32 82, metadata !48, i32 4} ; [ DW_TAG_lexical_block ]
!143 = metadata !{i32 125, i32 9, metadata !144, metadata !141}
!144 = metadata !{i32 786443, metadata !139, i32 123, i32 73, metadata !48, i32 5} ; [ DW_TAG_lexical_block ]
!145 = metadata !{i32 786688, metadata !144, metadata !"tmp", metadata !48, i32 124, metadata !51, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!146 = metadata !{i32 786688, metadata !118, metadata !"current_value", metadata !42, i32 43, metadata !51, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!147 = metadata !{i32 126, i32 9, metadata !144, metadata !141}
!148 = metadata !{i32 47, i32 2, metadata !118, null}
!149 = metadata !{i32 790531, metadata !150, metadata !"stream<float>.V", null, i32 105, metadata !134, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!150 = metadata !{i32 786689, metadata !151, metadata !"this", metadata !48, i32 16777321, metadata !133, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!151 = metadata !{i32 786478, i32 0, metadata !47, metadata !"operator<<", metadata !"operator<<", metadata !"_ZN3hls6streamIfElsERKf", metadata !48, i32 105, metadata !77, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !76, metadata !56, i32 105} ; [ DW_TAG_subprogram ]
!152 = metadata !{i32 105, i32 48, metadata !151, metadata !153}
!153 = metadata !{i32 51, i32 2, metadata !118, null}
!154 = metadata !{i32 790531, metadata !155, metadata !"stream<float>.V", null, i32 144, metadata !134, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!155 = metadata !{i32 786689, metadata !156, metadata !"this", metadata !48, i32 16777360, metadata !133, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!156 = metadata !{i32 786478, i32 0, metadata !47, metadata !"write", metadata !"write", metadata !"_ZN3hls6streamIfE5writeERKf", metadata !48, i32 144, metadata !77, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !94, metadata !56, i32 144} ; [ DW_TAG_subprogram ]
!157 = metadata !{i32 144, i32 48, metadata !156, metadata !158}
!158 = metadata !{i32 106, i32 9, metadata !159, metadata !153}
!159 = metadata !{i32 786443, metadata !151, i32 105, i32 88, metadata !48, i32 2} ; [ DW_TAG_lexical_block ]
!160 = metadata !{i32 786688, metadata !161, metadata !"tmp", metadata !48, i32 145, metadata !51, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!161 = metadata !{i32 786443, metadata !156, i32 144, i32 79, metadata !48, i32 3} ; [ DW_TAG_lexical_block ]
!162 = metadata !{i32 145, i32 31, metadata !161, metadata !158}
!163 = metadata !{i32 146, i32 9, metadata !161, metadata !158}
!164 = metadata !{i32 53, i32 2, metadata !118, null}
!165 = metadata !{i32 54, i32 3, metadata !118, null}
!166 = metadata !{i32 58, i32 2, metadata !118, null}
!167 = metadata !{i32 59, i32 3, metadata !118, null}
!168 = metadata !{i32 64, i32 1, metadata !118, null}

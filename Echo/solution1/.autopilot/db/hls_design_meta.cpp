...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("value_in_V_TDATA", 32, hls_in, 0, "axis", "in_data", 1),
	Port_Property("value_in_V_TVALID", 1, hls_in, 0, "axis", "in_vld", 1),
	Port_Property("value_in_V_TREADY", 1, hls_out, 0, "axis", "in_acc", 1),
	Port_Property("value_out_V_TDATA", 32, hls_out, 1, "axis", "out_data", 1),
	Port_Property("value_out_V_TVALID", 1, hls_out, 1, "axis", "out_vld", 1),
	Port_Property("value_out_V_TREADY", 1, hls_in, 1, "axis", "out_acc", 1),

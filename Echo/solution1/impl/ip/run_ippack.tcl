...
set Interfaces {
    s_axi_CTRL_BUS {
        ...
        registers {{0x10 delay W 0x0 "Data signal of delay" {{0 32 delay W 0 "Bit 31 to 0 Data signal of delay"}}} {0x18 scale W 0x0 "Data signal of scale" {{0 32 scale W 0 "Bit 31 to 0 Data signal of scale"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL_BUS value_in_V value_out_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 12 II x}
...
set enable_xo_gen 0
set kernel_files {/home/hildeb47/proj/ECE1373_GhostSynth/modules/Echo/src/Echo.cpp}
if {$enable_xo_gen} {
